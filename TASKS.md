...
All 26 backlog rows have corresponding `tasks/<id>.json` files. Generated by the Elyos task-decomposition agent on 2026-06-29. Validation: all 26 pass `validate-tasks.mjs`.

| File | Milestone | Type | Lane | Risk | Status |
|---|---|---|---|---|---|
| `tasks/know-your-rights-jurisdiction-000.json` | M0 | research | donated | medium | open |
| `tasks/know-your-rights-policy-001.json` | M0 (seed) | design-spec | donated | high | open |
| `tasks/know-your-rights-repo-002.json` | M0 | code | donated | low | open |
| `tasks/know-your-rights-schema-003.json` | M0 | code | donated | medium | open |
| `tasks/know-your-rights-lint-004.json` | M0 | code | donated | high | open |
| `tasks/know-your-rights-workflow-005.json` | M0 | design-spec | donated | medium | open |
| `tasks/know-your-rights-sources-006.json` | M1 | data | donated | high | open |
| `tasks/know-your-rights-provenance-007.json` | M1 | code | donated | medium | open |
| `tasks/know-your-rights-eval-008.json` | M1 | code | donated | medium | open |
| `tasks/know-your-rights-content-009.json` | M2 | writing | donated | high | open |
| `tasks/know-your-rights-card-010.json` | M2 | writing | donated | high | open |
| `tasks/know-your-rights-dataset-011.json` | M2 | data | donated | high | open |
| `tasks/know-your-rights-site-012.json` | M3 | code | donated | medium | open |
| `tasks/know-your-rights-a11y-013.json` | M3 | code | donated | medium | open |
| `tasks/know-your-rights-i18n-014.json` | M3 | code | donated | low | open |
| `tasks/know-your-rights-eval-015.json` | M4 | code | donated | medium | open |
| `tasks/know-your-rights-hardening-016.json` | M4 | code | donated | high | open |
| `tasks/know-your-rights-partner-017.json` | M5 | research | donated | high | open |
| `tasks/know-your-rights-handoff-018.json` | M5 | maintenance | donated | high | open |
| `tasks/know-your-rights-ops-019.json` | M6 | maintenance | donated | medium | open |
| `tasks/know-your-rights-worker-020.json` | Backlog | writing | donated | high | open |
| `tasks/know-your-rights-jurisdiction-021.json` | Backlog | data | donated | high | open |
| `tasks/know-your-rights-streetrights-022.json` | Backlog | writing | donated | high | open |
| `tasks/know-your-rights-immigration-023.json` | Backlog | writing | donated | high | open |
| `tasks/know-your-rights-i18n-024.json` | Backlog | writing (deliverable: translation) | donated | high | open |
| `tasks/know-your-rights-funded-025.json` | Backlog | maintenance | **funded** (cap: $500) | high | open |

**Guardrail notes applied during generation:**
- All content tasks frame outputs as "plain-language summaries of public law" — never legal advice.
- `riskTier: high` on all tasks that state a right, legal rule, or jurisdiction-specific obligation.
- Attorney sign-off in `acceptanceCriteria` for every HIGH-tier content task.
- `know-your-rights-i18n-024`: `type: "writing"` + `deliverable: "translation"` (never `type: "translation"`).
- `know-your-rights-funded-025`: `lane: "funded"` with `fundedBudgetUsd: 500` hard cap.
- `verifiedNeed: false` on all tasks (no partner secured as of generation date).
